...
-- TODO : This should all be doable exactly.
{- FIXME: Passes testcases on my machine, but not on Jeroen's:
    ...
    Should perhaps fail due to rounding issues, but doesn't always?
-}
